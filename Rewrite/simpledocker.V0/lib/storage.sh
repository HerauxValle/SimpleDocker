# lib/storage.sh — Storage profiles: _stor_meta_set, _stor_link/_unlink, _pick_storage_profile,
#                   _stor_create_profile, _persistent_storage_menu, export/import menus,
#                   _finish (container install finalizer)
