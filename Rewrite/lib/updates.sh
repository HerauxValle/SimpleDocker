# lib/updates.sh — Update engine: _blueprint_template, _list_blueprint_names (file),
#                   _blueprint_submenu (file editor), _collect_bps_by_type,
#                   _write_pkg_manifest, _do_pkg_update, _do_ubuntu_update,
#                   _build_update_items, _do_blueprint_update
